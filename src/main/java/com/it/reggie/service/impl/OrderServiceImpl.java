...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Orders> implements OrderService {
    ...
    public void submit(Orders orders) {
        ...
        if (shoppingCarts == null || shoppingCarts.size() == 0) {
            throw new CustomException("The shopping cart is empty, cannot place an order");
        }
        ...
        if (addressBook == null) {
            throw new CustomException("User address information is incorrect, cannot place an order");
        }
        ...
        // Insert data into the orders table, one record
        this.save(orders);

        // Insert data into the order details table, multiple records
